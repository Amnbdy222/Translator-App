                ...
                dialog.setItems(new String[]{"Twitter", "Instagram"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            ...
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/aman_dubey0960"));
                            startActivity(browserIntent);
                        } else if (which == 1) {
                            // Open the About website
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/aman_dubey_0960/"));
                            startActivity(browserIntent);
                        }
                    }
                });
